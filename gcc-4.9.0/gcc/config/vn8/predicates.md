;; Predicate definitions for ICDREC VN8 micro controllers.
...
(define_predicate "low_io_address_operand"
  (and (match_code "const_int")
       (match_test "IN_RANGE (INTVAL (op) - vn8_current_arch->sfr_offset,
                              0, 0x1f)")))
...
(define_predicate "nox_general_operand"
  (and (match_operand 0 "general_operand")
       (not (match_test "vn8_load_libgcc_p (op)"))
       (not (match_test "vn8_mem_memx_p (op)"))))
...
;;
(define_predicate "vn8_sp_immediate_operand"
  (and (match_code "const_int")
