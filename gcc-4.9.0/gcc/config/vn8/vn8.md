...
;;   for ICDREC VN8 micro controllers.
...
;;  r  POST_INC or PRE_DEC address as a register (r0, r2, r4)
...
;;  ~  Output 'r' if not VN8_HAVE_JMP_CALL.
;;  !  Output 'e' if VN8_HAVE_EIJMP_EICALL.
...
(define_constants
  [(REG_X       0)
   ...
   (REG_W       6)
   (REG_SP      32)
   (LPM_REGNO   30)      ; implicit target register of LPM
   (TMP_REGNO   30)      ; temporary register r0
   (ZERO_REGNO  31)      ; zero register r1
   ])
  ...
  (cond [(eq_attr "type" "branch")
         ...
         (if_then_else (and (ge (minus (pc) (match_dup 0))
                       ...
                       (if_then_else (and (ge (minus (pc) (match_dup 0))
                                     ...
                                     (const_int 4)))
         (eq_attr "type" "xcall")
         (if_then_else (match_test "!VN8_HAVE_JMP_CALL")
                       (const_int 1)
                       (const_int 2))]
        (const_int 2)))

;; Lengths of several insns are adjusted in vn8.c:adjust_insn_length().
...
(define_attr "enabled" ""
  (cond [(eq_attr "isa" "standard")
         ...
         (and (eq_attr "isa" "ijmp")
              (match_test "!VN8_HAVE_EIJMP_EICALL"))
         (const_int 1)
         ...
         (and (eq_attr "isa" "elpm")
              (match_test "VN8_HAVE_ELPM && !VN8_HAVE_ELPMX"))
         (const_int 1)

         (and (eq_attr "isa" "elpmx")
              (match_test "VN8_HAVE_ELPMX"))
         (const_int 1)

         (and (eq_attr "isa" "xmega")
              (match_test "VN8_XMEGA"))
         (const_int 1)
...
(define_insn "reload_in<mode>"
  ...
  {
    return vn8_out_lpm (insn, operands, NULL);
  }
...
(define_insn_and_split "xload8<mode>_A"
  ...
  "can_create_pseudo_p()
   && !vn8_xload_libgcc_p (<MODE>mode)
   && vn8_mem_memx_p (operands[1])
...
(define_insn_and_split "xload<mode>_A"
  ...
  [(clobber (const_int 0))]
  {
    ...
    emit_move_insn (reg_z, simplify_gen_subreg (HImode, addr, PSImode, 0));
    emit_move_insn (gen_rtx_REG (QImode, 9), addr_hi8);
    ...
    /* Move to destination */
    emit_move_insn (operands[0], gen_rtx_REG (<MODE>mode, 10));
...
(define_insn "xload<mode>_8"
  ...
  "!vn8_xload_libgcc_p (<MODE>mode)"
  {
    return vn8_out_xload (insn, operands, NULL);
  }
  [(set_attr "length" "4,4")
...
(define_insn "xload_<mode>_libgcc"
  [(set (reg:MOVMODE 10)
        (mem:MOVMODE (lo_sum:PSI (reg:QI 9)
                                 (reg:HI REG_Z))))
   (clobber (reg:QI 9))
   (clobber (reg:HI REG_Z))]
  "vn8_xload_libgcc_p (<MODE>mode)"
...
//        fprintf(stderr,"\n");
//        print_simple_rtl(stderr,dest);
//        fprintf(stderr,"\n");
//        print_simple_rtl(stderr,src);


    if (vn8_mem_memx_p (src))
      {
        rtx addr = XEXP (src, 0);
        ...
        if (!vn8_xload_libgcc_p (<MODE>mode))
...
(define_insn "movhi_sp_r"
  [(set (match_operand:HI 0 "stack_register_operand"                 "=q")
        (unspec_volatile:HI [(match_operand:HI 1 "register_operand"  "r")
                             (match_operand:HI 2 "const_int_operand" "LPNK")]
                            UNSPECV_WRITE_SP))]
  ""
  "@
	stio\t %B0,%B1\;stio\t %A0,%A1"
  [(set_attr "length" "2")
   (set_attr "isa" "no_xmega")
   (set_attr "cc" "none")])
...
(define_insn "*reload_inpsi"
  ...
  "reload_completed"
  {
    return vn8_out_reload_inpsi (operands, operands[2], NULL);
  }
  [(set_attr "length" "6")
...
(define_insn "*movpsi"
  ...
  {
    return vn8_out_movpsi (insn, operands, NULL);
  }
...
(define_insn "movmem_<mode>"
  ...
  ""
  {
    return vn8_out_movmem (insn, operands, NULL);
  }
...
(define_insn "*clrmemqi"
  ...
  ""
  "0:\;st\t %a0+,__zero_reg__\;dec\t %1\;bne\t 0b"
  [(set_attr "length" "3")
   (set_attr "cc" "clobber")])
...
(define_insn "*clrmemhi"
  ...
  ""
  "@
	0:\;st\t %a0+,__zero_reg__\;subiw\t %A1,1\;bne\t 0b
	0:\;st\t %a0+,__zero_reg__\;subi\t %A1,1\;subic\t %B1,0\;bne\t 0b"
  [(set_attr "length" "3,4")
...
(define_insn "*strlenhi"
  [(set (match_operand:HI 0 "register_operand"                      "=e")
        (unspec:HI [(mem:BLK (match_operand:HI 1 "register_operand"  "0"))
                   ...
                   UNSPEC_STRLEN))]
  ""
  "0:\;ld\t __tmp_reg__,%a0+\;tst\t __tmp_reg__\;bne\t 0b"
  [(set_attr "length" "3")
   (set_attr "cc" "clobber")])
...
(define_insn "*addhi3.sign_extend1"
  ...
  ""
  {
    return reg_overlap_mentioned_p (operands[0], operands[1])
      ? "mov\t __tmp_reg__,%1\;add\t %A0,%1\;addc\t %B0,__zero_reg__\;btbc\t __tmp_reg__,7\;dec\t %B0"
      : "add\t %A0,%1\;addc\t %B0,__zero_reg__\;btbc\t %1,7\;dec\t %B0";
  }
  [(set_attr "length" "5")
   (set_attr "cc" "clobber")])
...
(define_insn "*addhi3_sp"
  [(set (match_operand:HI 1 "stack_register_operand"           "=q")
        (plus:HI (match_operand:HI 2 "stack_register_operand"   "q")
                 (match_operand:HI 0 "vn8_sp_immediate_operand" "Csp")))]
  ""
  {
    return vn8_out_addto_sp (operands, NULL);
  }
  [(set_attr "length" "6")
...
(define_insn "*add<mode>3"
  ...
  ""
  {
    return vn8_out_plus (insn, operands);
  }
  [(set_attr "length" "2")
...
(define_insn "*addpsi3_zero_extend.qi"
  ...
  ""
  "add\t %A0,%A1\;addc\t %B0,__zero_reg__\;addc\t %C0,__zero_reg__"
  [(set_attr "length" "3")
   (set_attr "cc" "set_n")])
...
(define_insn "*addpsi3_zero_extend.hi"
  [(set (match_operand:PSI 0 "register_operand"                          "=r")
        (plus:PSI (zero_extend:PSI (match_operand:HI 1 "register_operand" "r"))
                  (match_operand:PSI 2 "register_operand"                 "0")))]
  ""
  "add\t %A0,%A1\;addc\t %B0,%B1\;addc\t %C0,__zero_reg__"
  [(set_attr "length" "3")
   (set_attr "cc" "set_n")])
...
(define_insn "*addpsi3_sign_extend.hi"
  [(set (match_operand:PSI 0 "register_operand"                          "=r")
        (plus:PSI (sign_extend:PSI (match_operand:HI 1 "register_operand" "r"))
                  (match_operand:PSI 2 "register_operand"                 "0")))]
  ""
  "add\t %A0,%1\;addc\t %B0,%B1\;addc\t %C0,__zero_reg__\;btbc\t %B1,7\;dec\t %C0"
  [(set_attr "length" "5")
   (set_attr "cc" "set_n")])

(define_insn "*addsi3_zero_extend.qi"
  [(set (match_operand:SI 0 "register_operand"                         "=r")
        (plus:SI (zero_extend:SI (match_operand:QI 1 "register_operand" "r"))
                 (match_operand:SI 2 "register_operand"                 "0")))]
  ""
  "add\t %A0,%1\;addc\t %B0,__zero_reg__\;addc\t %C0,__zero_reg__\;addc\t %D0,__zero_reg__"
  [(set_attr "length" "4")
   (set_attr "cc" "set_n")])
...
(define_insn "*addsi3_zero_extend.hi"
  [(set (match_operand:SI 0 "register_operand"                         "=r")
        (plus:SI (zero_extend:SI (match_operand:HI 1 "register_operand" "r"))
                 (match_operand:SI 2 "register_operand"                 "0")))]
  ""
  "add\t %A0,%1\;addc\t %B0,%B1\;addc\t %C0,__zero_reg__\;addc\t %D0,__zero_reg__"
  [(set_attr "length" "4")
   (set_attr "cc" "set_n")])
...
(define_insn "*subpsi3_zero_extend.qi"
  ...
  ""
  "sub\t %A0,%2\;subc\t %B0,__zero_reg__\;subc\t %C0,__zero_reg__"
  [(set_attr "length" "3")
   (set_attr "cc" "set_czn")])
...
(define_insn "*subpsi3_zero_extend.hi"
  ...
  ""
  "sub\t %A0,%2\;subc\t %B0,%B2\;subc\t %C0,__zero_reg__"
  [(set_attr "length" "3")
   (set_attr "cc" "set_czn")])
...
(define_insn "*subpsi3_sign_extend.hi"
  ...
  ""
  "sub\t %A0,%A2\;subc\t %B0,%B2\;subc\t %C0,__zero_reg__\;btbc\t %B2,7\;inc %C0"
  [(set_attr "length" "5")
   (set_attr "cc" "set_czn")])
...
(define_insn "*subhi3.sign_extend2"
  ...
  ""
  {
    return reg_overlap_mentioned_p (operands[0], operands[2])
      ? "mov\t __tmp_reg__,%2\;sub\t %A0,%2\;subc\t %B0,__zero_reg__\;btbc\t __tmp_reg__,7\;inc\t %B0"
      : "sub\t %A0,%2\;subc\t %B0,__zero_reg__\;btbc\t %2,7\;inc\t %B0";
  }
  [(set_attr "length" "5")
   (set_attr "cc" "clobber")])
...
(define_insn "*subsi3_zero_extend"
  ...
  ""
  "sub\t %A0,%2\;subc\t %B0,__zero_reg__\;subc\t %C0,__zero_reg__\;subc\t %D0,__zero_reg__"
  [(set_attr "length" "4")
   (set_attr "cc" "set_czn")])
...
(define_insn "*subsi3_zero_extend.hi"
  ...
  ""
  "sub\t %A0,%2\;subc\t %B0,%B2\;subc\t %C0,__zero_reg__\;subc\t %D0,__zero_reg__"
  [(set_attr "length" "4")
   (set_attr "cc" "set_czn")])
...
(define_insn "*mulqi3_enh"
  ...
  "VN8_HAVE_MUL"
";;Mul (s_8 x s_8) = (us_8 x us_8) => us_8
        mul\t %1,%2
        mov\t %0,r30
	clr\t r31"
  [(set_attr "length" "3")
...
(define_expand "mulqi3_call"
  [(set (reg:QI 12) (match_operand:QI 1 "register_operand" ""))
   ...
   (parallel [(set (reg:QI 12) (mult:QI (reg:QI 12) (reg:QI 10)))
              (clobber (reg:QI 10))])
   (set (match_operand:QI 0 "register_operand" "") (reg:QI 12))])
(define_insn "*mulqi3_call"
  [(set (reg:QI 12) (mult:QI (reg:QI 12) (reg:QI 10)))
   (clobber (reg:QI 10))]
  "!VN8_HAVE_MUL"
  "%~call\t __mulqi3"
  [(set_attr "type" "xcall")
...
(define_insn "*addhi3.lt0"
  ...
  "@
	btbc\t %1,7\;addiw\t %0,1
	sll\t %1,1\;addc\t %A0,__zero_reg__\;addc\t %B0,__zero_reg__"
  [(set_attr "length" "2,3")
   (set_attr "cc" "clobber")])
...
(define_insn "*addpsi3.lt0"
  [(set (match_operand:PSI 0 "register_operand"                         "=r")
        (plus:PSI (lshiftrt:PSI (match_operand:PSI 1 "register_operand"  "r")
                 ...
                 (match_operand:PSI 2 "register_operand"                 "0")))]
  ""
  "mov\t __tmp_reg__,%C1\;sll\t __tmp_reg__,1
	addc\t %A0,__zero_reg__\;addc\t %B0,__zero_reg__\;addc\t %C0,__zero_reg__"
  [(set_attr "length" "5")
   (set_attr "cc" "clobber")])
...
(define_insn "*addsi3.lt0"
  [(set (match_operand:SI 0 "register_operand"                       "=r")
        (plus:SI (lshiftrt:SI (match_operand:SI 1 "register_operand"  "r")
                 ...
                 (match_operand:SI 2 "register_operand"               "0")))]
  ""
  "mov\t __tmp_reg__,%D1\;sll\t __tmp_reg__,1
	addc\t %A0,__zero_reg__\;addc\t %B0,__zero_reg__\;addc\t %C0,__zero_reg__\;addc\t %D0,__zero_reg__"
  [(set_attr "length" "6")
   (set_attr "cc" "clobber")])

(define_insn "*umulqihi3.call"
  [(set (reg:HI 12)
        (mult:HI (zero_extend:HI (reg:QI 10))
...
(define_insn "*<any_extend:extend_su><any_extend2:extend_su>msubqihi4"
   ...
   && <any_extend:CODE> != <any_extend2:CODE>"
  {
    output_asm_insn (<any_extend:CODE> == SIGN_EXTEND
                     ? "mul\t %1,%2\;sub\t r31,%2"
                     : "mul\t %2,%1\;sub\t r31,%1", operands);

    return "add\t %A0,r30\;addc\t %B0,r31\;clr\t __zero_reg__";
  }
  [(set_attr "length" "6")
   (set_attr "cc" "clobber")])
...
(define_insn "*<any_extend:extend_su><any_extend2:extend_su>msubqihi4"
   ...
   && <any_extend:CODE> != <any_extend2:CODE>"
  {
    ...
    return "sub\t %A0,r30\;subc\t %B0,r31\;clr\t __zero_reg__";
  }
  [(set_attr "length" "6")
   (set_attr "cc" "clobber")])
...
(define_insn "*mulhi3_enh"
  ...
  "VN8_HAVE_MUL"
  {
    return REGNO (operands[1]) == REGNO (operands[2])
           ? "mul\t %A1,%A1\;movw\t %0,r30\;mul\t %A1,%B1\;add\t %B0,r30\;add\t %B0,r30\;clr\t r31"
           : "mul\t %A1,%A2\;movw\t %0,r0\;mul\t %A1,%B2\;add\t %B0,r30\;mul\t %B1,%A2\;add\t %B0,r30\;clr\t r31";
  }
  [(set_attr "length" "7")
   (set_attr "cc" "clobber")])
...
(define_expand "mulhi3_call"
  [(set (reg:HI 12) (match_operand:HI 1 "register_operand" ""))
   ...
   (parallel [(set (reg:HI 12) (mult:HI (reg:HI 12) (reg:HI 10)))
              (clobber (reg:HI 10))
              (clobber (reg:QI 9))])
   (set (match_operand:HI 0 "register_operand" "") (reg:HI 12))])

(define_insn "*mulhi3_call"
  [(set (reg:HI 12) (mult:HI (reg:HI 12) (reg:HI 10)))
   (clobber (reg:HI 10))
   (clobber (reg:QI 9))]
  "!VN8_HAVE_MUL"
  "%~call __mulhi3"
...
(define_insn_and_split "mulu<mode>si3"
  ...
  [(set (reg:HI 0)
   ...
   (set (reg:SI 6)
        (match_dup 2))
   (set (reg:SI 10)
        (mult:SI (zero_extend:SI (reg:HI 0))
                 (reg:SI 6)))
   (set (match_dup 0)
        (reg:SI 10))]
  {
...
(define_insn_and_split "muls<mode>si3"
  ...
  [(set (reg:HI 0)
   ...
   (set (reg:SI 6)
        (match_dup 2))
   (set (reg:SI 10)
        (mult:SI (sign_extend:SI (reg:HI 0))
                 (reg:SI 6)))
   (set (match_dup 0)
        (reg:SI 10))]
  {
...
(define_insn_and_split "mulohisi3"
  ...
  [(set (reg:HI 0)
   ...
   (set (reg:SI 6)
        (match_dup 2))
   (set (reg:SI 10)
        (mult:SI (not:SI (zero_extend:SI (not:HI (reg:HI 0))))
                 (reg:SI 6)))
   (set (match_dup 0)
        (reg:SI 10))])
        ...
        (reg:SI 10))]
  {
    ...
    if (<any_extend:CODE> == <any_extend2:CODE>
        || <any_extend:CODE> == ZERO_EXTEND)
      {
        operands[1] = xop1;
        operands[2] = xop2;
        operands[3] = gen_rtx_fmt_e (<any_extend:CODE>, SImode, gen_rtx_REG (HImode, 6));
        operands[4] = gen_rtx_fmt_e (<any_extend2:CODE>, SImode, gen_rtx_REG (HImode, 4));
      }
    else
      {
        ...
        operands[1] = xop2;
        operands[2] = xop1;
        operands[3] = gen_rtx_ZERO_EXTEND (SImode, gen_rtx_REG (HImode, 6));
        operands[4] = gen_rtx_SIGN_EXTEND (SImode, gen_rtx_REG (HImode, 4));
      }
  })
...
(define_expand "<extend_su>mulhi3_highpart"
  [(set (reg:HI 6)
   ...
   (parallel [(set (reg:HI 12)
                   (truncate:HI (lshiftrt:SI (mult:SI (any_extend:SI (reg:HI 6))
                                                      (any_extend:SI (reg:HI 0)))
                                             (const_int 16))))
              (clobber (reg:HI 10))])
   (set (match_operand:HI 0 "register_operand" "")
        (reg:HI 12))]
...
(define_insn "*<extend_u>mulhisi3_call"
  [(set (reg:SI 10)
        (mult:SI (any_extend:SI (reg:HI 6))
                 (any_extend:SI (reg:HI 0))))]
  "VN8_HAVE_MUL"
...
(define_insn "*usmulhisi3_call"
  [(set (reg:SI 10)
        (mult:SI (zero_extend:SI (reg:HI 6))
                 (sign_extend:SI (reg:HI 0))))]
  "VN8_HAVE_MUL"
  "%~call __usmulhisi3"
  [(set_attr "type" "xcall")
   (set_attr "cc" "clobber")])
...
(define_insn "*mul<extend_su>hisi3_call"
  [(set (reg:SI 10)
        (mult:SI (any_extend:SI (reg:HI 0))
                 (reg:SI 6)))]
  "VN8_HAVE_MUL"
...
(define_insn_and_split "divmodqi4"
  ...
  ""
  [(set (reg:QI 12) (match_dup 1))
   (set (reg:QI 10) (match_dup 2))
   (parallel [(set (reg:QI 12) (div:QI (reg:QI 12) (reg:QI 10)))
              (set (reg:QI 13) (mod:QI (reg:QI 12) (reg:QI 10)))
              (clobber (reg:QI 10))
              (clobber (reg:QI 11))])
   (set (match_dup 0) (reg:QI 12))
   (set (match_dup 3) (reg:QI 13))])
 ...
 [(parallel [(set (match_operand:QI 0 "pseudo_register_operand" "")
  ...
  [(set (reg:QI 12) (match_dup 1))
   ...
   (parallel [(set (reg:QI 12) (udiv:QI (reg:QI 12) (reg:QI 10)))
              (set (reg:QI 13) (umod:QI (reg:QI 12) (reg:QI 10)))
              (clobber (reg:QI 11))])
   (set (match_dup 0) (reg:QI 12))
   (set (match_dup 3) (reg:QI 13))])
...
(define_insn_and_split "divmodhi4"
  ...
  ""
  [(set (reg:HI 12) (match_dup 1))
   (set (reg:HI 10) (match_dup 2))
   (parallel [(set (reg:HI 10) (div:HI (reg:HI 12) (reg:HI 10)))
              (set (reg:HI 12) (mod:HI (reg:HI 12) (reg:HI 10)))
              (clobber (reg:HI 0))
              (clobber (reg:QI 9))])
   (set (match_dup 0) (reg:HI 10))
   (set (match_dup 3) (reg:HI 12))])

(define_insn "*divmodhi4_call"
  [(set (reg:HI 10) (div:HI (reg:HI 12) (reg:HI 10)))
   (set (reg:HI 12) (mod:HI (reg:HI 12) (reg:HI 10)))
   (clobber (reg:HI 0))
   (clobber (reg:QI 9))]
  ""
...
(define_insn_and_split "udivmodhi4"
  ...
  [(set (reg:HI 12) (match_dup 1))
   (set (reg:HI 10) (match_dup 2))
   (parallel [(set (reg:HI 10) (udiv:HI (reg:HI 12) (reg:HI 10)))
              (set (reg:HI 12) (umod:HI (reg:HI 12) (reg:HI 10)))
              (clobber (reg:HI 0))
              (clobber (reg:QI 9))])
   (set (match_dup 0) (reg:HI 10))
   (set (match_dup 3) (reg:HI 12))])
...
(define_insn "*udivmodhi4_call"
  [(set (reg:HI 10) (udiv:HI (reg:HI 12) (reg:HI 10)))
   (set (reg:HI 12) (umod:HI (reg:HI 12) (reg:HI 10)))
   (clobber (reg:HI 0))
   (clobber (reg:QI 9))]
  ""
...
(define_insn_and_split "mulsqipsi3"
  ...
  [(set (reg:QI 13)
   ...
   (set (reg:PSI 10)
        (match_dup 2))
   (set (reg:PSI 6)
        (mult:PSI (sign_extend:PSI (reg:QI 13))
                  (reg:PSI 10)))
   (set (match_dup 0)
        (reg:PSI 6))])
...
(define_insn_and_split "divmodpsi4"
  ...
  { gcc_unreachable(); }
  ""
  [(set (reg:PSI 10) (match_dup 1))
   (set (reg:PSI 6) (match_dup 2))
   (parallel [(set (reg:PSI 10) (div:PSI (reg:PSI 10) (reg:PSI 6)))
              (set (reg:PSI 6) (mod:PSI (reg:PSI 10) (reg:PSI 6)))
              (clobber (reg:QI 9))
              (clobber (reg:QI 13))
              (clobber (reg:QI 0))])
   (set (match_dup 0) (reg:PSI 10))
   (set (match_dup 3) (reg:PSI 6))])

(define_insn "*divmodpsi4_call"
  [(set (reg:PSI 10) (div:PSI (reg:PSI 10) (reg:PSI 6)))
   (set (reg:PSI 6) (mod:PSI (reg:PSI 10) (reg:PSI 6)))
   (clobber (reg:QI 9))
   (clobber (reg:QI 13))
   (clobber (reg:QI 0))]
...
(define_insn_and_split "udivmodpsi4"
  ...
  [(set (reg:PSI 10) (match_dup 1))
   (set (reg:PSI 6) (match_dup 2))
   (parallel [(set (reg:PSI 10) (udiv:PSI (reg:PSI 10) (reg:PSI 6)))
              (set (reg:PSI 6) (umod:PSI (reg:PSI 10) (reg:PSI 6)))
              (clobber (reg:QI 9))
              (clobber (reg:QI 13))
              (clobber (reg:QI 0))])
   (set (match_dup 0) (reg:PSI 10))
...
(define_insn "*udivmodpsi4_call"
  [(set (reg:PSI 10) (udiv:PSI (reg:PSI 10) (reg:PSI 6)))
   (set (reg:PSI 6) (umod:PSI (reg:PSI 10) (reg:PSI 6)))
   (clobber (reg:QI 9))
   (clobber (reg:QI 13))
   (clobber (reg:QI 0))]
...
(define_insn_and_split "divmodsi4"
  ...
  ""
  [(set (reg:SI 10) (match_dup 1))
   (set (reg:SI 6) (match_dup 2))
   (parallel [(set (reg:SI 6) (div:SI (reg:SI 10) (reg:SI 6)))
              (set (reg:SI 10) (mod:SI (reg:SI 10) (reg:SI 6)))
              (clobber (reg:HI 0))
              (clobber (reg:HI 4))])
   (set (match_dup 0) (reg:SI 6))
   (set (match_dup 3) (reg:SI 10))])

(define_insn "*divmodsi4_call"
  [(set (reg:SI 6) (div:SI (reg:SI 10) (reg:SI 6)))
   (set (reg:SI 10) (mod:SI (reg:SI 10) (reg:SI 6)))
   (clobber (reg:HI 0))
   (clobber (reg:HI 4))]
  ""
...
(define_insn_and_split "udivmodsi4"
  ...
  [(set (reg:SI 10) (match_dup 1))
   (set (reg:SI 6) (match_dup 2))
   (parallel [(set (reg:SI 6) (udiv:SI (reg:SI 10) (reg:SI 6)))
              (set (reg:SI 10) (umod:SI (reg:SI 10) (reg:SI 6)))
              (clobber (reg:HI 0))
              (clobber (reg:HI 4))])
   (set (match_dup 0) (reg:SI 6))
   (set (match_dup 3) (reg:SI 10))])
...
(define_insn "*udivmodsi4_call"
  [(set (reg:SI 6) (udiv:SI (reg:SI 10) (reg:SI 6)))
   (set (reg:SI 10) (umod:SI (reg:SI 10) (reg:SI 6)))
   (clobber (reg:HI 0))
   (clobber (reg:HI 4))]
  ""
...
(define_insn "andhi3"
  ...
  ""
  {
    ...
    return vn8_out_bitop (insn, operands, NULL);
  }
...
;; Expander used by __builtin_vn8_swap
...
(define_insn "*rotlqi3"
  ...
  ""
  "@
	sll\t %0,1\;addc\t %0,__zero_reg__
	sll\t %0\;addc\t %0,__zero_reg__\;sll\t %0\;addc\t %0,__zero_reg__
	swap %0\;bst %0,0\;ror %0\;bld %0,7
	swap %0
	swap %0\;sll\t %0\;addc\t %0,__zero_reg__
	swap %0\;sll\t %0\;addc\t %0,__zero_reg__\;sll\t %0\;addc\t %0,__zero_reg__
...
(define_insn "*rotlhi2.1"
  [(set (match_operand:HI 0 "register_operand"           "=r")
        (rotate:HI (match_operand:HI 1 "register_operand" "0")
                   (const_int 1)))]
  ""
  "sll\t %A0\;rlc\t %B0\;addc\t %A0,__zero_reg__"
  [(set_attr "length" "3")
   (set_attr "cc" "clobber")])
...
(define_insn "*rotlpsi2.1"
  [(set (match_operand:PSI 0 "register_operand"            "=r")
        (rotate:PSI (match_operand:PSI 1 "register_operand" "0")
                    (const_int 1)))]
  ""
  "sll\t %A0\;rlc\t %B0\;rlc\t %C0\;addc\t %A0,__zero_reg__"
  [(set_attr "length" "4")
   (set_attr "cc" "clobber")])
...
(define_insn "*rotlsi2.1"
  [(set (match_operand:SI 0 "register_operand"           "=r")
        (rotate:SI (match_operand:SI 1 "register_operand" "0")
                   (const_int 1)))]
  ""
  "sll\t %A0\;rlc\t %B0\;rlc\t %C0\;rlc\t %D0\;addc\t %A0,__zero_reg__"
  [(set_attr "length" "5")
   (set_attr "cc" "clobber")])
  ...
  [(set (match_dup 1)
   ...
   (set (match_dup 1)
        (and:QI (match_dup 1)
                (const_int -16)))]
  {
    operands[1] = vn8_to_int_mode (operands[0]);
  })
...
(define_peephole2 ; ashlqi3_l_const4
  ...
  {
    operands[2] = vn8_to_int_mode (operands[0]);
  })
...
(define_insn "*ashlpsi3"
  ...
  ""
  {
    return vn8_out_ashlpsi3 (insn, operands, NULL);
  }
...
(define_insn "ashrpsi3"
  ...
  ""
  {
    return vn8_out_ashrpsi3 (insn, operands, NULL);
  }
...
(define_insn "lshrpsi3"
  ...
  ""
  {
    return vn8_out_lshrpsi3 (insn, operands, NULL);
  }
...
(define_insn "neghi2"
  ...
  ""
  "@
	neg %B0\;neg %A0\;subc %B0,__zero_reg__
	clr %A0\;clr %B0\;sub %A0,%A1\;subc %B0,%B1"
  [(set_attr "length" "3,4")
   (set_attr "cc" "set_czn")])
...
(define_insn "negpsi2"
  ...
  ""
  "@
	com %C0\;com %B0\;neg %A0\;subic %B0,-1\;subic %C0,-1
	com %C0\;com %B0\;com %A0\;addc\t %A0,__zero_reg__\;addc\t %B0,__zero_reg__\;addc\t %C0,__zero_reg__
	clr %A0\;clr %B0\;clr %C0\;sub %A0,%A1\;subc %B0,%B1\;subc %C0,%C1"
...
(define_insn "negsi2"
  ...
  ""
  "@
	com %D0\;com %C0\;com %B0\;neg %A0\;subic %B0,lo8(-1)\;subic %C0,lo8(-1)\;subic %D0,lo8(-1)
	com %D0\;com %C0\;com %B0\;com %A0\;addc\t %A0,__zero_reg__\;addc\t %B0,__zero_reg__\;addc\t %C0,__zero_reg__\;addc\t %D0,__zero_reg__
	clr %A0\;clr %B0\;clr %C0\;clr %D0\;sub %A0,%A1\;subc %B0,%B1\;subc %C0,%C1\;subc %D0,%D1
	clr %A0\;clr %B0\;movw %C0,%A0\;sub %A0,%A1\;subc %B0,%B1\;subc %C0,%C1\;subc %D0,%D1"
...
(define_insn "extendqihi2"
  ...
  ""
  "@
	clr %B0\;btbc\t %0,7\;com %B0
	mov %A0,%A1\;clr %B0\;btbc\t %A0,7\;com %B0"
  [(set_attr "length" "3,4")
   (set_attr "cc" "set_n,set_n")])
...
(define_insn "extendqipsi2"
  ...
  ""
  "@
	clr %B0\;btbc\t %A0,7\;com %B0\;mov %C0,%B0
	mov %A0,%A1\;clr %B0\;btbc\t %A0,7\;com %B0\;mov %C0,%B0"
  [(set_attr "length" "4,5")
   (set_attr "cc" "set_n,set_n")])
...
(define_insn "extendqisi2"
  ...
  ""
  "@
	clr %B0\;btbc\t %A0,7\;com %B0\;mov %C0,%B0\;mov %D0,%B0
	mov %A0,%A1\;clr %B0\;btbc\t %A0,7\;com %B0\;mov %C0,%B0\;mov %D0,%B0"
  [(set_attr "length" "5,6")
   (set_attr "cc" "set_n,set_n")])
...
(define_insn "extendhipsi2"
  ...
  ""
  "@
	clr %C0\;btbc\t %B0,7\;com %C0
	mov %A0,%A1\;mov %B0,%B1\;clr %C0\;btbc\t %B0,7\;com %C0
	movw %A0,%A1\;clr %C0\;btbc\t %B0,7\;com %C0"
...
(define_insn "extendhisi2"
  ...
  ""
  "@
	clr %C0\;btbc\t %B0,7\;com %C0\;mov %D0,%C0
	mov %A0,%A1\;mov %B0,%B1\;clr %C0\;btbc\t %B0,7\;com %C0\;mov %D0,%C0
	movw %A0,%A1\;clr %C0\;btbc\t %B0,7\;com %C0\;mov %D0,%C0"
...
(define_insn "*negated_tsthi"
  ...
  "!flag_wrapv && !flag_trapv && flag_strict_overflow"
  "cp __zero_reg__,%A0
	cmpc\t __zero_reg__,%B0"
[(set_attr "cc" "compare")
 (set_attr "length" "2")])

;; Leave here the clobber used by the cmphi pattern for simplicity, even
;; though it is unused, because this pattern is synthesized by vn8_reorg.
...
(define_insn "*negated_tstpsi"
  [(set (cc0)
        (compare (neg:PSI (match_operand:PSI 0 "register_operand" "r"))
                 (const_int 0)))]
  "!flag_wrapv && !flag_trapv && flag_strict_overflow"
  "cp __zero_reg__,%A0\;cmpc\t __zero_reg__,%B0\;cmpc\t __zero_reg__,%C0"
  [(set_attr "cc" "compare")
   (set_attr "length" "3")])
...
(define_insn "*negated_tstsi"
  ...
  "cmp\t __zero_reg__,%A0
	cmpc\t __zero_reg__,%B0
	cmpc\t __zero_reg__,%C0
	cmpc\t __zero_reg__,%D0"
  [(set_attr "cc" "compare")
   (set_attr "length" "4")])
...
(define_insn "*reversed_tst<mode>"
  ...
  ""
  "cmp\t __zero_reg__,%A1
	cmpc\t __zero_reg__,%B1
	cmpc\t __zero_reg__,%C1
	cmpc\t __zero_reg__,%D1"
  [(set_attr "cc" "compare")
   (set_attr "length" "4")])
...
(define_insn "*cmp<mode>"
  ...
  ""
  {
    switch (which_alternative)
      ...
      case 0:
      case 1:
        return vn8_out_tsthi (insn, operands, NULL);

      case 2:
        return "cp %A0,%A1\;cmpc\t %B0,%B1";

      case 3:
        if (<MODE>mode != HImode)
          break;
        return reg_unused_after (insn, operands[0])
               ? "subi %A0,lo8(%1)\;subic %B0,hi8(%1)"
               : "ldi\t %2,hi8(%1)\;cmpi\t %A0,lo8(%1)\;cmpc\t %B0,%2";

      case 4:
        if (<MODE>mode != HImode)
          break;
        return "ldi %2,lo8(%1)\;cp %A0,%2\;ldi %2,hi8(%1)\;cmpc\t %B0,%2";
      }

    return vn8_out_compare (insn, operands, NULL);
  }
  [(set_attr "cc" "compare")
...
(define_insn "*cmppsi"
  ...
  ""
  {
    switch (which_alternative)
      {
      case 0:
        return vn8_out_tstpsi (insn, operands, NULL);

      case 1:
        return "cp %A0,%A1\;cmpc\t %B0,%B1\;cmpc\t %C0,%C1";

      case 2:
        return reg_unused_after (insn, operands[0])
               ? "subi %A0,lo8(%1)\;subic %B0,hi8(%1)\;subic %C0,hh8(%1)"
               : "cmpi\t %A0,lo8(%1)\;ldi %2,hi8(%1)\;cmpc\t %B0,%2\;ldi %2,hh8(%1)\;cmpc\t %C0,%2";

      case 3:
        return "ldi %2,lo8(%1)\;cp %A0,%2\;ldi %2,hi8(%1)\;cmpc\t %B0,%2\;ldi %2,hh8(%1)\;cmpc\t %C0,%2";
      }
...
(define_insn "*cmp<mode>"
  ...
  ""
  {
    if (0 == which_alternative)
      return vn8_out_tstsi (insn, operands, NULL);
    else if (1 == which_alternative)
      return "cp %A0,%A1\;cmpc\t %B0,%B1\;cmpc\t %C0,%C1\;cmpc\t %D0,%D1";
...
(define_insn "*sbrx_branch<mode>"
  ...
  ""
  {
    return vn8_out_sbxx_branch (insn, operands);
  }
  [(set (attr "length")
...
(define_insn "branch"
  ...
  ""
  {
    return ret_cond_branch (operands[1], vn8_jump_mode (operands[0], insn), 0);
  }
...
;; ****************************************************************
;; VN8 does not have following conditional jumps: LE,LEU,GT,GTU.
...
(define_insn "rvbranch"
  ...
  ""
  {
    return ret_cond_branch (operands[1], vn8_jump_mode (operands[0], insn), 1);
  }
  [(set_attr "type" "branch1")
   (set_attr "cc" "clobber")])
...
(define_insn "jump"
  ...
  ""
  {
    return VN8_HAVE_JMP_CALL && get_attr_length (insn) != 1
           ? "jmp %x0"
           : "rjmp %x0";
  }
  [(set (attr "length")
...
(define_expand "indirect_jump"
  ...
  ""
  {
    if (!VN8_HAVE_JMP_CALL && !register_operand (operands[0], HImode))
      {
...
;; table jump
;; For entries in jump table see vn8_output_addr_vec_elt.
...
;; Lower half of the I/O space - use subic/sbis directly.
...
;; Upper half of the I/O space - read port to __tmp_reg__ and use btbc\t/btbs\t.
...
(define_peephole ; "*dec-and-branchsi!=-1.d.clobber"
  ...
  ""
  {
    ...
    if (test_hard_reg_class (ADDW_REGS, operands[0]))
      output_asm_insn ("subiw %0,1" CR_TAB
                       "subc %C0,__zero_reg__" CR_TAB
                       "subc %D0,__zero_reg__", operands);
    else
      output_asm_insn ("subi %A0,1" CR_TAB
                       "subc %B0,__zero_reg__" CR_TAB
                       "subc %C0,__zero_reg__" CR_TAB
                       "subc %D0,__zero_reg__", operands);

    jump_mode = vn8_jump_mode (operands[2], insn);
...
(define_peephole ; "*dec-and-branchhi!=-1"
  ...
  ""
  {
    ...
    CC_STATUS_INIT;
    if (test_hard_reg_class (ADDW_REGS, operands[0]))
      output_asm_insn ("subiw %0,1", operands);
    else
      output_asm_insn ("subi %A0,1" CR_TAB
                       "subc %B0,__zero_reg__", operands);
...
(define_peephole ; "*dec-and-branchqi!=-1"
  ...
  ""
  {
    ...
    jump_mode = vn8_jump_mode (operands[1], insn);
    op = ((EQ == <CODE>) ^ (jump_mode == 1)) ? "brcc" : "brcs";
  ...
  [(set (cc0)
   ...
   (set (pc)
        (if_then_else (ne (cc0)
                      ...
                      (pc)))]
  "!VN8_HAVE_JMP_CALL
   || !(vn8_current_device->dev_attribute & VN8_ERRATA_SKIP)"
  {
    if (operands[2] == CONST0_RTX (<MODE>mode))
      operands[2] = zero_reg_rtx;

    return 3 == vn8_jump_mode (operands[0], insn)
      ? "cpse %1,%2\;jmp %0"
      : "cpse %1,%2\;rjmp %0";
  })
...
(define_insn "return"
  [(return)]
  "reload_completed && vn8_simple_epilogue ()"
  "ret"
  [(set_attr "cc" "none")
   (set_attr "length" "1")])
...
(define_expand "epilogue"
  ...
  ""
  {
    vn8_expand_epilogue (false /* sibcall_p */);
    DONE;
  })
...
(define_expand "sibcall_epilogue"
  ...
  ""
  {
    vn8_expand_epilogue (true /* sibcall_p */);
    DONE;
  })
...
(define_insn "insert_bits"
  ...
  ""
  {
    return vn8_out_insert_bits (operands, NULL);
  }
  [(set_attr "adjust_len" "insert_bits")
   (set_attr "cc" "clobber")])


;; __builtin_vn8_flash_segment
...
;; Best place would be to fold ADDR_SPACE_CONVERT_EXPR in vn8_fold_builtin.
;; However, vn8_addr_space_convert can add some built-in knowledge for PSTR
...
(define_insn "*insv.io"
  ...
  "@
	cbi %i0,%1
	sbi %i0,%1
	btbc\t %2,0\;sbi %i0,%1\;btbs\t %2,0\;cbi %i0,%1"
...
(define_insn "*insv.not.io"
  ...
  ""
  "btbs\t %2,0\;sbi %i0,%1\;btbc\t %2,0\;cbi %i0,%1"
  [(set_attr "length" "4")
   (set_attr "cc" "none")])
...
(include "vn8-fixed.md")

;; Operations on 64-bit registers
(include "vn8-dimode.md")
