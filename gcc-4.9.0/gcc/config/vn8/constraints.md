;; Constraint definitions for ICDREC VN8 micro controllers.
...
(define_register_constraint "t" "R0_REG"
  "Temporary register r31")

(define_register_constraint "b" "BASE_POINTER_REGS"
  "Base pointer registers (r2--r5)")

(define_register_constraint "e" "POINTER_REGS"
  "Pointer registers (r0--r5)")

(define_register_constraint "w" "ADDW_REGS"
  "Registers from r0 to r7.  These registers
   can be used in @samp{addiw} command.")
...
(define_constraint "Cxf"
  ...
  (and (match_code "const_int")
       (match_test "vn8_has_nibble_0xf (op)")))
...
(define_constraint "Y01"
  ...
  (ior (and (match_code "const_fixed")
            (match_test "1 == INTVAL (vn8_to_int_mode (op))"))
...
(define_constraint "Y02"
  ...
  (ior (and (match_code "const_fixed")
            (match_test "2 == INTVAL (vn8_to_int_mode (op))"))
...
(define_constraint "YIJ"
  ...
  (and (match_code "const_fixed")
       (match_test "IN_RANGE (INTVAL (vn8_to_int_mode (op)), -63, 63)")))
