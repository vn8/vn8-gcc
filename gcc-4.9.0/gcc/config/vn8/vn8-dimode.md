...
;;   for Atmel VN8 micro controllers.
;;   Copyright (C) 1998-2014 Free Software Foundation, Inc.
;;   Contributed by Georg Lay (vn8@gjlay.de)
;;
...
;; implementation for VN8.  The trouble with DImode is that tree -> RTL
...
(define_insn "compare_const_<mode>2"
  ...
  "vn8_have_dimode
   && !s8_operand (operands[0], VOIDmode)"
  {
    return vn8_out_compare64 (insn, operands, NULL);
  }
...
(define_expand "<extend_u>mulsidi3"
  ...
  "vn8_have_dimode"
  {
    emit_move_insn (gen_rtx_REG (SImode, 10), operands[1]);
    emit_move_insn (gen_rtx_REG (SImode, 6), operands[2]);
...
(define_insn "<extend_u>mulsidi3_insn"
  [(set (reg:DI ACC_A)
        (mult:DI (any_extend:DI (reg:SI 6))
                 (any_extend:DI (reg:SI 10))))
