...
(define_insn "fract<FIXED_B:mode><FIXED_A:mode>2"
  ...
  {
    return vn8_out_fract (insn, operands, true, NULL);
  }
  [(set_attr "cc" "clobber")
...
(define_insn "fractuns<FIXED_B:mode><FIXED_A:mode>2"
  ...
  "<FIXED_B:MODE>mode != <FIXED_A:MODE>mode"
  {
    return vn8_out_fract (insn, operands, false, NULL);
  }
  [(set_attr "cc" "clobber")
...
(define_insn "round<mode>3_const"
  ...
  ""
  {
    return vn8_out_round (insn, operands);
  }
  [(set_attr "cc" "clobber")
